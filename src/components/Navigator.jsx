  ...
  return (
    <>
		<div className='relative'>
			<div className='sticky top-0 left-0'> {/*sticky and top-0 not working*/}
				...
				<div className={`${open ? 'w-48' : 'w-0'} text-white lg:w-60 h-screen relative duration-500 gradient-bg`}>
